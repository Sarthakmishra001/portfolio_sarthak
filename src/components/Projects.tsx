...
const projects: Project[] = [
  ...
  },
  {
    id: 2,
    title: 'EchoChat',
    description: 'Real-time chat platform with secure auth and video calling',
    longDescription: 'A real-time communication platform that enables users to create or join chat rooms, exchange instant messages, and make one-to-one video calls directly in the browser with secure authentication and live user status.',
    image: '/imgs/echochat.gif',
    tags: ['Node.js', 'Express.js', 'MongoDB', 'Mongoose', 'EJS', 'WebSockets', 'WebRTC', 'JWT'],
  ...
  },
  {
    id: 4,
    title: 'Chess Master',
    description: 'A real-time multiplayer chess platform',
    longDescription: 'A real-time multiplayer chess platform where players can get matched, play live games, and track their match history through an interactive browser-based chessboard with validated moves and smooth gameplay.',
    image: '/imgs/chess master.gif',
    tags: ['Node.js', 'Express.js', 'JavaScript', 'EJS', 'WebSockets', 'Chess.js'],
    liveUrl: 'https://chess-master-kguu.onrender.com',
    githubUrl: 'https://github.com/Sarthakmishra001/chess-master',
    color: 'hsl(45, 100%, 50%)',
  },
];
